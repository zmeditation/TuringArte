...
const CreateNFT = () => {
  ...
  const fileStyle = useMemo(
    () => (
      `dark:bg-nft-black-1 bg-white border dark:border-white border-nft-gray-2 flex flex-col NFTs-center p-5 rounded-sm border-dashed  
  ...
  const createMarket = async () => {
    ...
    try {
      ...
      const url = `https://ipfs.infura.io:5001/ipfs/2Krbekx8wTJWoIJ8SqJC58Fc9LX/'${added.path}`;
  ...
  return (
    <div className="flex justify-center sm:px-4 p-12">
      <div className="w-3/5 md:w-full">
        <h1 className="font-poppins dark:text-white text-nft-black-1 font-semibold text-2xl">Mint new NFT</h1>
